...
import com.example.cameraxproject.util.overlay.BarcodeGraphicBase
 ...
 */
internal class BarcodeReticleGraphic(overlay: PreviewView, private val animator: CameraReticleAnimator) :
